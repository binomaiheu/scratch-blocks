...
Blockly.FieldMatrix8.fromJson = function(options) {
  return new Blockly.FieldMatrix8(options['matrix8']);
};
 ...
 * @const
 */
Blockly.FieldMatrix8.THUMBNAIL_NODE_SIZE = 2;// 4;
 ...
 * @const
 */
Blockly.FieldMatrix8.ARROW_SIZE = 18; // 12;
 ...
 * @const
 */
Blockly.FieldMatrix8.MATRIX_NODE_SIZE = 14;
...
Blockly.FieldMatrix8.prototype.checkForLED_ = function(e) {
  ...
  return xDiv + (yDiv * 8); // this had nodePad which is dangerous !
};

/**
 * Clean up this FieldMatrix8, as well as the inherited Field.
